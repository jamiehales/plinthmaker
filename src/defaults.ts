...
export const DEFAULT_JIG_WALL_SIZE = 3
export const DEFAULT_JIG_HEIGHT = 10
export const DEFAULT_JIG_OVERLAP = 2
...
export const DEFAULT_TOP_ANGLE = 30
export const DEFAULT_ROUND_STYLE: RoundStyle = 'none'
export const DEFAULT_ROUND_LOCATION: RoundLocation = 'top'
export const DEFAULT_ROUND_SIZE = 1
...
export const DEFAULT_SUPPORT_SPACING = 2.5
